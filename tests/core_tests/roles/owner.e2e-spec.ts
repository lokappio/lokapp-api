...
describe("Tests OWNER", () => {
  ...
  describe("Test project", () => {
    ...
    it("Delete", async () => {
      await EdgeHelper.validRequest(ProjectsTestHelpers.deleteProject(app, tester.id, project.id));
    });
  });
  ...
  describe("Test user", () => {
    ...
    it("Update Manager into Owner", async () => {
      ...
      await EdgeHelper.validRequest(ProjectsTestHelpers.updateUserRole(app, tester.id, project.id, admin.id, dto));
    });
    ...
    it("Delete", async () => {
      await EdgeHelper.validRequest(ProjectsTestHelpers.removeUserFromProject(app, tester.id, project.id, admin.id));
    });
  });
});